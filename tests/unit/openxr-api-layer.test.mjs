...
test("API-layer protocol and source retain the D3D11 single-overlay contract", async () => {
  ...
  assert.deepEqual(protocol.graphicsApis, ["d3d11"]);
  ...
  assert.doesNotMatch(source, /XR_INFINITE_DURATION/);
